...
function Created ()
{
	...
	{
		m_AssignAll=R6MenuAssignAllButton(CreateWindow(Class'R6MenuAssignAllButton',WinWidth - Class'R6MenuAssignAllButton'.Default.UpRegion.W - 1,0.00,Class'R6MenuAssignAllButton'.Default.UpRegion.W,m_2DWeaponHeight));
	...
	m_2DBullet=R6WindowButtonGear(CreateWindow(Class'R6WindowButtonGear',m_2DWeaponWidth,0.00,m_fBulletWidth,m_2DBulletHeight,self));
	m_2DBullet.ToolTipString=Localize("Tip","GearRoomAmmo","R6Menu");
	m_2DBullet.bUseRegion=True;
	m_2DBullet.m_iDrawStyle=5;
	m_2DWeaponGadget=R6WindowButtonGear(CreateWindow(Class'R6WindowButtonGear',m_2DWeaponWidth,m_2DBullet.WinTop + m_2DBullet.WinHeight,m_2DBullet.WinWidth,WinHeight - m_2DBulletHeight,self));
...
function Paint (Canvas C, float X, float Y)
{
	...
	DrawStretchedTextureSegment(C,m_2DWeaponWidth,0.00,m_LinesRegion.W,WinHeight,m_LinesRegion.X,m_LinesRegion.Y,m_LinesRegion.W,m_LinesRegion.H,m_LinesTexture);
	DrawStretchedTextureSegment(C,m_2DWeaponWidth + 1,m_2DWeaponGadget.WinTop,m_2DWeaponGadget.WinWidth - 1,m_LinesRegion.H,m_LinesRegion.X,m_LinesRegion.Y,m_LinesRegion.W,m_LinesRegion.H,m_LinesTexture);
	DrawSimpleBorder(C);
}
...
defaultproperties
{
    ...
    m_2DWeaponWidth=130.00
    m_2DWeaponHeight=79.00
    m_fBulletWidth=65.00
