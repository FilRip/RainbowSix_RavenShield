...
function Created ()
{
	...
	m_pInGameGiveOrderPopUp=R6WindowPopUpBox(CreateWindow(Class'R6WindowPopUpBox',0.00,0.00,640.00,480.00));
	m_pInGameGiveOrderPopUp.CreatePopUpFrameWindow(Localize("Defensive","ID_HEADER","R6RecMessages"),R6MenuRSLookAndFeel(LookAndFeel).GetTextHeaderSize(),m_RMsgSize.X,m_RMsgSize.Y,m_RMsgSize.W,m_RMsgSize.H);
	m_pInGameGiveOrderPopUp.bAlwaysBehind=True;
	m_pInGameGiveOrderPopUp.m_bBGFullScreen=False;
	m_TextDefensive[0]=R6WindowTextLabel(CreateWindow(Class'R6WindowTextLabel',5.00,m_RMsgSize.Y + 30,WinWidth - 5,25.00,self));
	...
	m_TextDefensive[1]=R6WindowTextLabel(CreateWindow(Class'R6WindowTextLabel',5.00,m_RMsgSize.Y + 50,WinWidth - 5,25.00,self));
	...
	m_TextDefensive[2]=R6WindowTextLabel(CreateWindow(Class'R6WindowTextLabel',5.00,m_RMsgSize.Y + 70,WinWidth - 5,25.00,self));
	...
	m_TextDefensive[3]=R6WindowTextLabel(CreateWindow(Class'R6WindowTextLabel',5.00,m_RMsgSize.Y + 90,WinWidth - 5,25.00,self));
	...
	m_TextDefensive[4]=R6WindowTextLabel(CreateWindow(Class'R6WindowTextLabel',5.00,m_RMsgSize.Y + 110,WinWidth - 5,25.00,self));
	...
	m_TextDefensive[5]=R6WindowTextLabel(CreateWindow(Class'R6WindowTextLabel',5.00,m_RMsgSize.Y + 130,WinWidth - 5,25.00,self));
	...
	m_TextDefensive[6]=R6WindowTextLabel(CreateWindow(Class'R6WindowTextLabel',5.00,m_RMsgSize.Y + 150,WinWidth - 5,25.00,self));
