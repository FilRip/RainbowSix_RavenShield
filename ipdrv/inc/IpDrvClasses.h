...
public:
    ...
    DECLARE_FUNCTION(execGetMaxAvailPorts);
    DECLARE_FUNCTION(execCheckForPlayerTimeouts);
    DECLARE_FUNCTION(execSetPlayingTime);
...
AUTOGENERATE_FUNCTION(AUdpLink,-1,execCheckForPlayerTimeouts);
AUTOGENERATE_FUNCTION(AUdpLink,-1,execSetPlayingTime);
AUTOGENERATE_FUNCTION(AUdpLink,-1,execGetPlayingTime);
