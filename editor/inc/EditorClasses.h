...
public:
    ...
    INT ClickFlags;
    INT ConstraintsVtbl;
    BITFIELD bFastRebuild:1 GCC_PACK(4);
    ...
    BITFIELD LoadEntirePackageWhenSaving:1;
    FLOAT MovementSpeed GCC_PACK(4);
    FLOAT SnapDistance;
    ...
    DECLARE_CLASS(UEditorEngine,UEngine,0|CLASS_Transient|CLASS_Config,Editor)
