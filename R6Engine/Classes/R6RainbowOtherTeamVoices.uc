...
function PlayRainbowOtherTeamVoices (R6Pawn aPawn, ERainbowOtherTeamVoices eRainbowVoices)
{
...
function PlayRainbowTeamVoices (R6Pawn aPawn, ERainbowTeamVoices eRainbowVoices)
{
	switch (eRainbowVoices)
	{
		case RTV_PlacingBug:
