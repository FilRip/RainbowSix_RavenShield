...
defaultproperties
{
    ...
    m_MyGadgets(1)=Class'R6DescCMAG9mmMP5'
    m_MyGadgets(2)=Class'R6DescSilencerSubGuns'
    m_Bullets(0)=Class'R6Desc10mmAutoFMJ'
    m_Bullets(1)=Class'R6Desc10mmAutoJHP'
    m_MagTag="R63RDMAG10MM"
    m_2dMenuRegion=(X=16917003,Y=571080704,W=308,H=8462852)
    m_NameID="SUBMP510A2"
}
/*
