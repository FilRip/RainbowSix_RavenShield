...
defaultproperties
{
    ...
    m_MyGadgets(0)=Class'R6DescMAGCZ61High2'
    m_MyGadgets(1)=Class'R6DescSilencerSubGuns'
    m_Bullets(0)=Class'R6Desc765mmAutoFMJ'
    m_Bullets(1)=Class'R6Desc765mmAutoJHP'
    m_MagTag="R63RDMAGCZ61"
    m_2dMenuRegion=(X=5054986,Y=570687488,W=129,H=5054981)
    m_NameID="SUBCZ61"
}
/*
